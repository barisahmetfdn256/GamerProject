...
namespace MernisDoğrulama
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="MernisDoğrulama.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<MernisDoğrulama.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(MernisDoğrulama.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public MernisDoğrulama.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(MernisDoğrulama.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public MernisDoğrulama.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(MernisDoğrulama.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public interface KPSPublicSoapChannel : MernisDoğrulama.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisDoğrulama.KPSPublicSoap>, MernisDoğrulama.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MernisDoğrulama.TCKimlikNoDogrulaResponse> MernisDoğrulama.KPSPublicSoap.TCKimlikNoDogrulaAsync(MernisDoğrulama.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MernisDoğrulama.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            MernisDoğrulama.TCKimlikNoDogrulaRequest inValue = new MernisDoğrulama.TCKimlikNoDogrulaRequest();
            inValue.Body = new MernisDoğrulama.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MernisDoğrulama.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
        ...
        internal bool TCKimlikNoDogrula(long v, string v1, object toUpper)
        {
            throw new NotImplementedException();
        }

        internal bool TCKimlikNoDogrula(long v2, short v, string firstName, string v1)
        {
            throw new NotImplementedException();
        }
